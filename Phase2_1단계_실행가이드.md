...
**⚠️ 1단계↔2단계 연결 참고**
- **권장 실행 순서**: 1-1 → 1-2 → 1-3. 1-3(VLOOKUP) 적용 후 시트1은 **22컬럼**이 됩니다.
- 1-3 적용 **이후** 1-1/1-2를 다시 실행해도 됩니다. 스크립트가 시트1 컬럼 수(17 vs 22)를 자동 감지해 배정상태/등록일·수정일 열에 맞게 적용합니다.
- **2단계 API** 사용 시 시트1은 **22컬럼(VLOOKUP 적용)** 상태여야 합니다. 자세한 내용은 `DEBUG_명세서_1단계_2단계_연결.md` 참고.
